    ...
    var submissionCategoryChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: ['#7180AC', '#FDAAAA', '#FFF7AE', 'rgba(75, 192, 192, 0.2)'],  // Colors for the bars
                borderColor: ['#2B4570', '#F97C7C', 'rgba(255, 206, 86, 1)', 'rgba(75, 192, 192, 1)'],  // Border color for the bars
                borderWidth: 1
            }]
        },
        options: {
